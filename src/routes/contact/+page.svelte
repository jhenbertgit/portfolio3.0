			...
			<div class="max-w-screen-lg mx-auto p-5">
				<div class="grid grid-cols-1 md:grid-cols-2 gap-16">
					<form on:submit={onSubmit} class="flex flex-col gap-5">
						...
						<div class="flex flex-col gap-1">
							<label for="subject" class="text-black dark:text-white"> Subject </label>
							<input
								id="subject"
								type="text"
								autocomplete="off"
						...
						<div>
							<button
								class="rounded mt-2 py-1 px-4 hover:opacity-75
					...
					<div class="">
						<h1 class="text-black dark:text-white text-2xl font-bold">Other ways to contact</h1>
						<h1
							class="text-1xl font-bold my-2 pt-2
					   text-zinc-600 dark:text-zinc-400 border-t border-t-zinc-200 dark:border-t-zinc-700"
						...
						<ul class="flex flex-wrap gap-2">
							{#each social as item}
								<li
									class="flex justify-center items-center h-8 w-8 p-1 mb-2 rounded
						...
						<h1
							class="text-1xl font-bold mt-2 py-2
					  text-zinc-600 dark:text-zinc-400 border-t border-t-zinc-200 dark:border-t-zinc-700"
						>
							Direct Email
						</h1>
