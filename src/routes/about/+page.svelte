	...
	{#if mounted}
		<div id="content" class="py-12" transition:fly={{ y: 100, delay: 1000 }}>
			<div class="max-w-screen-md mx-auto p-5">
				...
				<section>
					<h2 class="text-2xl font-bold mt-10 text-black dark:text-white">Introduction</h2>
				...
				<!-- SKILLS SECTION -->
				<section>
					<h2 class="text-black dark:text-white py-5 text-2xl font-bold">Skills</h2>
				...
				<!-- EXPERIENCE SECTION -->
				<section>
					<h2 class="text-black dark:text-white mt-10 mb-5 text-2xl font-bold">Experience</h2>
					<ul class="flex flex-col gap-4">
						{#each experience as experience}
							<li
								class="flex flex-col border rounded p-5
